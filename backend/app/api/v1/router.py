...
from app.api.v1.admin.decks import router as admin_decks_router
from app.api.v1.admin.diary_entries import router as admin_diary_entries_router
...
from app.api.v1.diary_photos import router as diary_photos_router
...
api_v1_router.include_router(diary_photos_router)
...
api_v1_router.include_router(admin_decks_router)
api_v1_router.include_router(admin_deck_cards_router)
