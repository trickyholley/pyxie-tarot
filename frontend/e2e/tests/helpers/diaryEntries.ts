 ...
 * fixture data. Returns the owning user's credentials - its unique username scopes the admin table row. */
export async function seedDiaryEntry(request: APIRequestContext, prefix: string): Promise<Credentials> {
